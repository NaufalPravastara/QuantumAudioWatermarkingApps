...
import 'package:ta_capstone/models/question_model_lsb.dart';
import 'package:ta_capstone/screens/home_screen.dart';

class QuizLsb extends StatefulWidget {
  @override
  State<QuizLsb> createState() => _QuizLsbState();
}

class _QuizLsbState extends State<QuizLsb> {
  //define the datas
