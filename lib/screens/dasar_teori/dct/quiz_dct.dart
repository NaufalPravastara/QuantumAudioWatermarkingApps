...
import 'package:ta_capstone/models/question_model_dct.dart';
import 'package:ta_capstone/screens/home_screen.dart';

class QuizDct extends StatefulWidget {
  @override
  State<QuizDct> createState() => _QuizDctState();
}

class _QuizDctState extends State<QuizDct> {
  //define the datas
